...
import PerfomanceStatistic from '@/components/perfomance-statistic/page';
import SkillsAndWallet from '@/components/skills-and-wallet/page';
import TabPanel from '@/components/tab-panel/page';
