...
export default function EditProfileDialog({ open, onOpenChange, userData, onSuccess }: EditProfileDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-125 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 rounded-3xl p-8 border-none shadow-2xl transition-colors">
        <DialogHeader>
          <DialogTitle className="text-2xl font-black text-slate-900 dark:text-slate-100 flex items-center gap-2">
            <FiEdit3 className="text-blue-600 dark:text-blue-400" /> Edit Profil
          </DialogTitle>
        ...
        <form onSubmit={handleUpdateProfile} className="space-y-5 mt-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 text-sm focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-500/30 focus:border-blue-500 dark:focus:border-blue-500 transition-all outline-none"
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 rounded-xl bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 text-sm focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-500/30 focus:border-blue-500 dark:focus:border-blue-500 transition-all outline-none resize-none placeholder:text-slate-400 dark:placeholder:text-slate-600"
            />
          ...
          <DialogFooter className="pt-4 gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-8 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 dark:disabled:bg-blue-800 text-white font-bold text-sm rounded-2xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-blue-600/20 dark:shadow-none cursor-pointer disabled:cursor-not-allowed"
            >
